...
const Home = () => {
  ...
  return (
    <>
      ...
      <p className="p-6 w-[90%] md:w-[80%] lg-[70%] text-xl mx-auto text-center">
        The Department of Mechanical Engineering was established in the year
        1991 with an intake of 60 students, which was increased to 120 students
        in the year 2009. Since its inception, the Department has been offering
        a four-year B.E. program in Mechanical Engineering at undergraduate
        level while at the postgraduate level, it offers Ph.D. program in
        Mechanical Engineering.
      </p>

      <div className="w-[80%] flex flex-col justify-center items-center mx-auto">
        <img src="./images/1.svg" alt="flowchart-1" />
      ...
      <div className="p-6 mx-auto w-[90%] md:w-[80%] lg-[70%]">
        <video
          ...
          src="https://docs.google.com/uc?id=1RHHOqgpT-3lWfI7WMDYLNdKMxX7zfyVi"
          muted
          autoplay="autoplay"
          controls
          loop
      ...
      <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500 text-center py-4 mb-4">
          ...
          <div className="rounded-lg shadow-lg bg-[#161a1d] max-w-sm">
            <div className="h-64 w-full">
              <img
                ...
                src={Data.homePage.dynamechLink}
                alt=""
                loading="lazy"
              />
            </div>
            <div className="p-6">
              ...
              <p className="text-gray-200 text-base mb-4">
                'MESA' is an organization which works for the benefits of the
                students. The purpose of MESA is to enrich students with
                different qualities to enhance their personality and emerges as
                multi-functional engineer who is recognized globally.
              </p>
              <Link
                to="/mesa"
        ...
        <div className="flex justify-center">
          <div className="rounded-lg shadow-lg bg-[#161a1d] max-w-sm">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-200 text-base mb-4">
                Team Maverick is the official formula student team of PVG's
                COET. We participate in two events called Supra and Formula
                Bharat. Supra is a National level event conducted at the Buddha
                International Circuit in Noida, and F1 Bharat is an
                international event held in Coimbatore.
              </p>
              <Link
                to="/supra"
                className=" inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
        ...
        <div className="flex justify-center">
          <div className="rounded-lg shadow-lg bg-[#161a1d] max-w-sm">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-200 text-base mb-4">
                We are a team from PVGCOET that designs, fabricates, tests, and
                competes for an ATV at national level competitions. 'Built with
                Passion, Driven with Pride'
              </p>
              <Link
                to="/baja"
                className=" inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
      ...
      <div className="p-6 mx-auto w-[90%] md:w-[80%] lg-[70%]">
        <video
          className="my-3 mx-auto"
          src="https://docs.google.com/uc?id=12HVT14R1iXDTZMERw-39wycQQQOLXSLu"
          muted
          autoplay="autoplay"
          controls
          loop
        ...
        {Data.piLab.map((ele, idx) => {
          return (
            <div className="w-full h-full">
              <img
                className="rounded-lg cursor-pointer hover:scale-[1.01] w-full h-full object-cover transition-all"
                key={idx}
                src={ele.link}
                alt={`piLab-${idx}`}
              />
      ...
      <div className="p-6 mx-auto w-[90%] md:w-[80%] lg-[70%]">
        <video
          className="my-3 mx-auto"
          src="https://docs.google.com/uc?id=15hAvgP9Cae7VAtyf5rueScz1Ok-kKxX9"
          autoplay="autoplay"
          controls
          loop
        />
